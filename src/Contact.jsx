    ...
    <div className="page-shell">
      ...
      <section className="hero-cinematic" style={{minHeight:"60vh"}}>
        ...
        <div className="container hero-content fade-up">
          ...
          <p className="hero-subtitle">Free consultation, no obligation. We respond within 2 hours.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"1px",background:"rgba(255,255,255,0.06)"}}>
            <div style={{background:"#000",padding:"48px"}}>
              ...
              <div style={{fontSize:"1.4rem",fontWeight:700,color:"#fff",marginBottom:10}}>For sales &amp; enquiries</div>
              <div style={{fontSize:"0.88rem",color:"rgba(255,255,255,0.45)",lineHeight:1.65,marginBottom:24}}>Best for CCTV quotes, urgent enquiries and quick consultations. Fastest response guaranteed.</div>
              <a className="btn-cine-primary" href="https://wa.me/27769414251?text=Hello%20I%20am%20interested%20in%20your%20security%20services" target="_blank" rel="noreferrer">Message on WhatsApp</a>
            </div>
            <div style={{background:"#000",padding:"48px"}}>
              ...
              <a className="btn-cine-primary" href="mailto:dt3bza@gmail.com?subject=Security%20Inquiry">dt3bza@gmail.com</a>
            </div>
          </div>
          <div style={{marginTop:"1px",background:"rgba(255,255,255,0.06)"}}>
            <div style={{background:"#000",padding:"48px"}}>
              ...
              <div style={{fontSize:"0.88rem",color:"rgba(255,255,255,0.45)",lineHeight:1.65}}>Free on-site security assessment within 50km of Cape Town. We assess your environment personally and recommend the right solution — no salespeople, no pressure.</div>
            </div>
          </div>
        </div>
      </section>

      <a className="floating-whatsapp" href="https://wa.me/27769414251?text=Hello%20I%20am%20interested%20in%20your%20security%20services" target="_blank" rel="noreferrer">WhatsApp Us</a>
      <Footer />
    </div>
  );
}
